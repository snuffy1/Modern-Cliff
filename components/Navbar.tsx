    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="hidden lense md:block w-1/2 h-full relative">
            <img
              src="/lense.svg"
              alt="Decorative lens flare"
              className="w-full h-full object-contain absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-16"
